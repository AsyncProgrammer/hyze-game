...
public final class Launcher {
    ...
    public static void main(String[] args) {
    	...
    	try {
    		...
    		System.out.println("" + Settings.SERVER_NAME + " is starting up, please be patient...");
    		Cache.init();
    		ItemManager.inits();
    		ItemsEquipIds.init();
    		Huffman.init();
        ...
        System.out.println("Guardian is now Online (Port: "+Settings.PORT_ID+", Launch Time: "+((double)(end - start) / 1000)+"s)");
    }
